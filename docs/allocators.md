...
The important inversion from a malloc-centric world is that the arena is the
primary allocator and bulk free is the primary lifetime tool. The pool and the general
