...
generic struct instance. Naming each column after its field is the whole trick,
and it makes both access patterns fall out of machinery that already exists:
