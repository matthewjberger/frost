...
pub enum Expression {
    ...
    Sizeof(crate::types::Type),
    TypeName(crate::types::Type),
    TypeId(crate::types::Type),
...
impl<'a> Splicer<'a> {
    ...
    pub fn expression(
        ...
        let node = match self.source.expr(id).clone() {
            ...
            Expression::TypeName(ty) => Expression::TypeName(ty),
            Expression::TypeId(ty) => Expression::TypeId(ty),
